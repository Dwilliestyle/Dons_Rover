...
from rover_msgs.action import Patrol


class RoverPatrolClient(Node):

    def __init__(self):
        super().__init__('rover_patrol_client')
        ...
        self._action_client = ActionClient(self, Patrol, 'rover')
...
def main(args=None):
    ...
    rover_patrol_client = RoverPatrolClient()

    rclpy.spin(rover_patrol_client)
